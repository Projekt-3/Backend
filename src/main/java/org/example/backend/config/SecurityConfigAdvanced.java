    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/contact","/dashboard/manager/register/show", "/dashboard/manager/shows","/dashboard/manager/shows/**","/dashboard/manager/shows/${showId}/employees","/healthz","/dashboard/manager/employees","/dashboard/manager/employees/{id}","/dashboard/manager/register/employee", "/dologin", "/healthz",
