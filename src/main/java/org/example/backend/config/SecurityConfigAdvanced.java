    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        .requestMatchers("/contact",  "/dologin","/dashboard/shift/{shiftId}/employee/{employeeId}","/dashboard/manager/register/shift", "/healthz", "/dashboard/manager/register/show").permitAll()
